...
<div class="container">
    ...
    <div class="jumbotron" style="margin-top: 20px;">
        <p class="text-center">
            <h1>Kinobooking.com</h1>
            <p class="lead">
                Kinobooking - это сервис, предоставляющий возможность бронирования билетов на киносеансы в Москве.
            </p>
            ...
            <sec:authorize access="isAuthenticated()">
                ...
                <p><a class="btn btn-lg btn-primary" href="<c:url value="/bookings" />" role="button">Мои бронирования</a></p>
